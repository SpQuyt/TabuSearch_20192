...
/**
 * Visitor design pattern, used to add trace statements to the program's
 * branches.
 *
 * <p>
 * A trace statement is added to each branch of if, while, do, switch, for
 * statements, by resorting to the instrumentation of the enclosed
 * statement blocks.
 */
public class BranchTraceVisitor extends ParseTreeVisitor {
   ...
   * 
   * <p>
   * Control dependences are printed to the path file.
   */
  ...
  /**
   * Resorts to visit(StatementList) to add trace statement to each catch
   * block. 
   */
